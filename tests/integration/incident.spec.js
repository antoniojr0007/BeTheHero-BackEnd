  ...
  it('should be able to show all incidents', async () => {
    await request(app)
      ...
      .then((response) => {
        ...
        expect(response.body[0]).toHaveProperty(
          'description',
          'Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus voluptatem error itaque eum assumenda cumque ullam cupiditate quod, libero veritatis id consequatur dignissimos facilis quae tenetur alias temporibus esse numquam!'
        );
        ...
        expect(response.body[0]).toHaveProperty('cnpj', '33333333333333');
